...
## 🚀 Features
- Add income and expense transactions with categories, amounts, dates, and descriptions
- View detailed transaction history
- Monthly and overall balance summary
...
- **No external dependencies** – zero `pip install` needed!
